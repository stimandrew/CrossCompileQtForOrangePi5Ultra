...
cmake ../src/qt-everywhere-src-6.5.5/ -GNinja -DCMAKE_BUILD_TYPE=Release -DQT_BUILD_EXAMPLES=OFF -DQT_BUILD_TESTS=OFF -DBUILD_qtwebengine=OFF  -DCMAKE_INSTALL_PREFIX=$HOME/qt6/host -DBUILD_SHARED_LIBS=OFF
```
```
